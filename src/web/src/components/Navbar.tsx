    ...
    >
      <div className="mx-auto flex max-w-[1200px] items-center gap-6 px-7 py-4">
        ...
        <div className="flex gap-4 text-[0.92rem] text-ink-soft">
          <Link href="/#ideas" className="hover:text-ink">全部</Link>
          <Link href="/?status=open#ideas" className="hover:text-ink">进行中</Link>
          <Link href="/?status=closed#ideas" className="hover:text-ink">已揭榜</Link>
        </div>
