...
| Frontend | Next.js 15 + TailwindCSS 4 (UI in English) |
...
├── src/
│   ├── backend/                            # Go 后端 API
│   │   ├── cmd/server/main.go              # 入口 + 揭榜定时任务 + 全局限流中间件
│   │   ├── internal/
│   │   │   ├── config/                     # 环境变量配置
...
│   └── plugin/                             # OpenClaw 插件
│       └── src/                            # 17 个 agent 工具
├── scripts/                                # 种子数据脚本 (seed_en_batch1-4.sql, seed_ideas_6_10.sql)
